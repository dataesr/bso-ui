...
export const chartOptions = {
  ...
  'data.general.repositories.datasets-by-license': {
    getOptions: (id, intl, categories, data, dataTitle) => {
      const options = getGraphOptions({ id, intl, dataTitle });
      options.chart.type = 'column';
      options.chart.height = '600px';
  ...
  'data.general.repositories.datasets-by-client-id': {
    getOptions: (id, intl, categories, data, dataTitle) => {
      const options = getGraphOptions({ id, intl, dataTitle });
      options.chart.type = 'column';
      options.chart.height = '600px';
  ...
  'general.dynamique.chart-evolution-historical': {
    getOptions: (id, intl, data, studyType) => {
      const options = getGraphOptions({ id, intl, studyType });
      options.chart.type = 'bar';
      options.plotOptions = {
  ...
  'general.dynamique.chart-evolution-10-years-within-1-year': {
    getOptions: (id, intl, data, studyType) => {
      const options = getGraphOptions({ id, intl, studyType });
      options.chart.type = 'bar';
      options.plotOptions = {
  ...
  'data.general.mentions.datasets-with-at-least-one-explicit-mention': {
    getOptions: (id, intl, categories, data, dataTitle) => {
      const options = getGraphOptions({ id, intl, dataTitle });
      options.chart.type = 'column';
      options.xAxis = {
      ...
      options.yAxis = getPercentageYAxis();
      options.yAxis.title.text = intl.formatMessage({
        id: 'app.with-at-least-one-explicit-mention',
      });
      options.legend.enabled = false;
      options.plotOptions = {
        column: {
  ...
  'software.general.mentions.software-with-at-least-one-explicit-mention': {
    getOptions: (id, intl, categories, data, dataTitle) => {
      const options = getGraphOptions({ id, intl, dataTitle });
      options.chart.type = 'column';
      options.xAxis = {
  ...
  'publishing.journals.sources.wikipedia': {
    getOptions: (id, intl, data) => {
      const options = getGraphOptions({ id, intl });
      options.chart.type = 'column';
      options.legend.enabled = false;
