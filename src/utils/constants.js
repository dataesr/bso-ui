...
export const documentTitles = {
  ...
  '/a-propos/notes-flash': 'app.header.nav.about.notes-flash',
  '/about/flash-notes': 'app.header.nav.about.notes-flash',
  ...
  '/a-propos/methodologie': 'app.header.nav.about.methodology',
  '/about/methodology': 'app.header.nav.about.methodology',
  '/about/glossary': 'app.header.nav.about.glossary',
  '/a-propos/glossaire': 'app.header.nav.about.glossary',
